...
class MunicipiosControllerTest < ActionController::TestCase
  ...
  test "should create municipio" do
    assert_difference('Municipio.count') do
      post :create, municipio: { codigo_municipio: @municipio.codigo_municipio, departamento_id: @municipio.departamento_id, nombre_municipio: @municipio.nombre_municipio, tipo_municipio: @municipio.tipo_municipio }
    end
  ...
  test "should update municipio" do
    patch :update, id: @municipio, municipio: { codigo_municipio: @municipio.codigo_municipio, departamento_id: @municipio.departamento_id, nombre_municipio: @municipio.nombre_municipio, tipo_municipio: @municipio.tipo_municipio }
    assert_redirected_to municipio_path(assigns(:municipio))
  end
